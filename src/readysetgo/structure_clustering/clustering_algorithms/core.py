...
class ClusteringAlgorithm(ABC):
    def __init__(self, tolerance: float, atoms_list: list = [], global_descriptor_object=None, global_descriptor_array: np.ndarray=None, base_atoms=None, iterations: int=1000, verbose: int = 0, ):
    ...
    allowed_value_types ={'tolerance': float, 'atoms_list': list, 'verbose': int, 'iterations': int}
    ...
    def make_gd_array(self):
        ...
        assert all(
            "global_descriptor" in atoms.info for atoms in self.atoms_list
