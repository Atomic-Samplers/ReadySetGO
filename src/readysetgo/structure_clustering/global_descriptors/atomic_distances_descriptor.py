...
class AtomicDistancesDescriptor(GlobalDescriptor):
    ...
    def __init__(self, structure=None, verbose=0, dimensions=128):
        super().__init__(structure, verbose, dimensions)
        self.descriptor_name = "Atomic Distances"

    def get_max_possible_distance(self) -> float:
        """
